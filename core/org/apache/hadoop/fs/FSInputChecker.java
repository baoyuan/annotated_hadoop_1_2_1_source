 ...
 * data before it is read by a user.<br/>
 * 为数据输入提供了检验能力
 */
...
abstract public class FSInputChecker extends FSInputStream {
  ...
  throws IOException {
    ...
    //将FSInputChecker的缓冲区的数据拷贝到用户缓冲区
   ...
   * @throws ChecksumException if there is a mismatch<br/>
   * 比较校验和，若不等则会抛出异常
   */
