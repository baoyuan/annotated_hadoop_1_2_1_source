 ...
 *
 *****************************************************************<br/>
 *引入了一个规则，即每个文件的CRC校验信息保存在.filename.crc文件中，如example.txt文件的校验信息保存在.example.txt.crc文件中
 */
public abstract class ChecksumFileSystem extends FilterFileSystem {
   ...
   * It generates checksums for data.<br/> 
   * 在基本具体文件系统输出流的基础上，实现数据文件和校验信息文件的数据输出
   * */
  ...
  /**
   * Rename files/dirs
   * 如果一个有CRC校验信息的文件要改名，则其校验信息也要随之改名
   */
